 ...
 */
#ifndef SHIELD_UTIL_H
#define SHIELD_UTIL_H
...
extern const char * const SHIELD_CONF_FILENAME;
extern const char * const SHIELD_PID_FILENAME;
...
{
    std::string s = strprintf("shield-%s", name);
