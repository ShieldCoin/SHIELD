...
#ifndef SHIELD_PRIMITIVES_BLOCK_H
#define SHIELD_PRIMITIVES_BLOCK_H
...
enum
{
    ...
    BLOCK_VERSION_X16S           = (11 << 11), //'101100000000000' 11
};
...
static inline int GetAlgoByName(std::string strAlgo){
    ...
    if (strAlgo == "blake" || strAlgo == "blake2s")
	    return ALGO_BLAKE;
    if (strAlgo == "x16s" || strAlgo == "X16s" || strAlgo == "X16S")
        return ALGO_X16S;
...
#endif // SHIELD_PRIMITIVES_BLOCK_H
