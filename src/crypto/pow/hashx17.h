#ifndef SHIELD_CRYPTO_POW_HASHX17_H
#define SHIELD_CRYPTO_POW_HASHX17_H
...
#include <crypto/pow/sph_shabal.h>
#include <crypto/pow/sph_whirlpool.h>
#include <crypto/pow/sph_sha2.h>
#include <crypto/pow/sph_haval.h>
