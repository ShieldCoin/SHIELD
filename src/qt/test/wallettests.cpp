...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<SHIELDAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_shield-qt -platform xcb      # Linux
//     src/qt/test/test_shield-qt -platform windows  # Windows
//     src/qt/test/test_shield-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = SHIELDUnits::formatWithUnit(unit, balance, false, SHIELDUnits::separatorAlways);
    ...
    // Amount input
    SHIELDAmountField* amountInput = receiveCoinsDialog.findChild<SHIELDAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: shield:")) != -1);
