    ...
    mapper(0)
{
    ...
    ui->shieldAtStartup->setToolTip(ui->shieldAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->shieldAtStartup->setText(ui->shieldAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openSHIELDConfButton->setToolTip(ui->openSHIELDConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new SHIELDUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->shieldAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openSHIELDConfButton_clicked()
{
