...
#ifndef SHIELD_QT_SHIELDUNITS_H
#define SHIELD_QT_SHIELDUNITS_H
...
/** SHIELD unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SHIELDUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SHIELDUnits(QObject *parent);

    /** SHIELD units.
      @note Source: https://en.shield.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        XSH,
...
typedef SHIELDUnits::Unit SHIELDUnit;

#endif // SHIELD_QT_SHIELDUNITS_H
