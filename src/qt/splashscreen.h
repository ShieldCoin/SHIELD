...
#ifndef SHIELD_QT_SPLASHSCREEN_H
#define SHIELD_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. SHIELD Core initialization
...
#endif // SHIELD_QT_SPLASHSCREEN_H
