...
* shield.conf: contains configuration settings for shieldd or shield-qt
* shieldd.pid: stores the process id of shieldd while running
...
* debug.log: contains debug information and general logging generated by shieldd or shield-qt
