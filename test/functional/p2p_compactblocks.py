...
# TestP2PConn: A peer we use to send messages to shieldd, and store responses.
...
class CompactBlocksTest(SHIELDTestFramework):
    ...
    # This test actually causes shieldd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that shieldd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for shieldd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # shieldd will not send blocktxn responses for blocks whose height is
