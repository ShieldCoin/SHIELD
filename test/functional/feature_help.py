...
"""Verify that starting shield with -h works as expected."""
import subprocess

from test_framework.test_framework import SHIELDTestFramework
from test_framework.util import assert_equal

class HelpTest(SHIELDTestFramework):
    ...
    def run_test(self):
        self.log.info("Start shield with -h for help text")
        ...
        self.log.info("Start shield with -version for version information")
        ...
        self.log.info("Start shieldd with -fakearg to make sure it does not start")
